...
class Renderer
{
    ...
    class (n)
    {
        var s, mthds, con, bind, b, bn, _240_50_, mi
        ...
        if ((mthds != null ? mthds.length : undefined))
        {
            ...
            if (bind.length)
            {
                ...
                for (var _238_22_ = 0; _238_22_ < list.length; _238_22_++)
                {
                    ...
                    con.keyval.val.func.body.exps = ((_240_50_=con.keyval.val.func.body.exps) != null ? _240_50_ : [])
    ...
    function (n)
    {
        var s, mthds, con, bind, b, bn, _291_50_, mi
        ...
        if ((mthds != null ? mthds.length : undefined))
        {
            ...
            if (bind.length)
            {
                ...
                for (var _289_22_ = 0; _289_22_ < list.length; _289_22_++)
                {
                    b = list[_289_22_]
                    bn = b.keyval.val.func.name.text
                    con.keyval.val.func.body.exps = ((_291_50_=con.keyval.val.func.body.exps) != null ? _291_50_ : [])
                    con.keyval.val.func.body.exps.unshift({type:'code',text:`this[\"${bn}\"] = this[\"${bn}\"].bind(this)`})
                }
            }
            this.indent = '    '
    ...
    {
        var bind, m, name, con, _352_37_, ast
    ...
    func (n, name)
    {
        var gi, _375_29_, _375_22_, s, args, _380_29_, _380_21_, str, ths, vs, v, t, ss
    ...
    if (n)
    {
        var first, last, gi, s, e, _506_24_, elif, _510_28_, _514_36_, _522_28_
        ...
        s += gi + "{\n"
        var list = ((_506_24_=n.then) != null ? _506_24_ : [])
        ...
        s += gi + "}"
        var list1 = ((_510_28_=n.elifs) != null ? _510_28_ : [])
        for (var _510_17_ = 0; _510_17_ < list1.length; _510_17_++)
        {
            elif = list1[_510_17_]
            s += '\n'
            s += gi + `else if (${this.atom(elif.elif.cond)})\n`
            s += gi + "{\n"
            var list2 = ((_514_36_=elif.elif.then) != null ? _514_36_ : [])
            for (var _514_18_ = 0; _514_18_ < list2.length; _514_18_++)
            {
                e = list2[_514_18_]
                s += this.indent + this.node(e) + '\n'
            }
        ...
        if (n.else)
        {
            ...
            s += gi + 'else\n'
            s += gi + "{\n"
            var list3 = ((_522_28_=n.else) != null ? _522_28_ : [])
            for (var _522_18_ = 0; _522_18_ < list3.length; _522_18_++)
            {
                e = list3[_522_18_]
                s += this.indent + this.node(e) + '\n'
            }
    ...
    ifInline (n)
    {
        ...
        {
            s += (function () { var result = []; var list = (n.then != null ? n.then : []); for (var _541_33_ = 0; _541_33_ < list.length; _541_33_++)  { e = list[_541_33_];result.push(this.atom(e))  } return result }).bind(this)().join(', ')
        }
        if (n.elifs)
        {
            var list1 = (n.elifs != null ? n.elifs : [])
            for (var _544_18_ = 0; _544_18_ < list1.length; _544_18_++)
            {
                e = list1[_544_18_]
                s += ' : '
        ...
        if (n.else)
        {
            ...
            {
                s += '(' + (function () { var result = []; var list2 = (n.else != null ? n.else : []); for (var _553_42_ = 0; _553_42_ < list2.length; _553_42_++)  { e = list2[_553_42_];result.push(this.atom(e))  } return result }).bind(this)().join(', ') + ')'
            }
        }
        return s
    }
    ...
    {
        var list, _649_27_, gi, nl, eb, g2, listVar, iterVar, s, _671_28_, j, v, e, _683_24_, prefix, postfix
        ...
        {
            if (((_649_27_=n.list.array) != null ? _649_27_.items[0] != null ? _649_27_.items[0].slice : undefined : undefined) || n.list.slice)
            {
        ...
        var list1 = ((_683_24_=n.then) != null ? _683_24_ : [])
        for (var _683_14_ = 0; _683_14_ < list1.length; _683_14_++)
        {
            e = list1[_683_14_]
    ...
    {
        var slice, _700_46_, _700_28_, gi, nl, eb, g2, iterVar, _710_32_, iterStart, iterEnd, start, end, iterCmp, iterDir, s, e, _729_24_, prefix, postfix

        slice = ((_700_46_=((_700_28_=n.list.array) != null ? _700_28_.items[0] != null ? _700_28_.items[0].slice : undefined : undefined)) != null ? _700_46_ : n.list.slice)
        gi = lineBreak || this.ind()
        nl = lineBreak || '\n'
        eb = lineBreak && ';' || '\n'
        g2 = lineBreak ? '' : this.indent
        iterVar = ((_710_32_=n.vals.text) != null ? _710_32_ : n.vals[0].text)
        ...
        s += gi + "{" + nl
        var list = ((_729_24_=n.then) != null ? _729_24_ : [])
        for (var _729_14_ = 0; _729_14_ < list.length; _729_14_++)
        {
            e = list[_729_14_]
            prefix = lastPrefix && e === n.then.slice(-1)[0] ? lastPrefix : ''
            postfix = lastPostfix && e === n.then.slice(-1)[0] ? lastPostfix : ''
    ...
    {
        var gi, nl, eb, g2, key, _751_26_, val, obj, s, e, _760_24_, prefix, postfix

        gi = lineBreak || this.ind()
        nl = lineBreak || '\n'
        eb = lineBreak && ';' || '\n'
        g2 = lineBreak ? '' : this.indent
        key = ((_751_26_=n.vals.text) != null ? _751_26_ : (n.vals[0] != null ? n.vals[0].text : undefined))
        ...
        var list = ((_760_24_=n.then) != null ? _760_24_ : [])
        for (var _760_14_ = 0; _760_14_ < list.length; _760_14_++)
        {
            e = list[_760_14_]
            prefix = lastPrefix && e === n.then.slice(-1)[0] ? lastPrefix : ''
            postfix = lastPostfix && e === n.then.slice(-1)[0] ? lastPostfix : ''
    ...
    while (n)
    {
        ...
        s += gi + "{\n"
        var list = ((_798_24_=n.then) != null ? _798_24_ : [])
        for (var _798_14_ = 0; _798_14_ < list.length; _798_14_++)
        {
            e = list[_798_14_]
            s += this.indent + this.node(e) + '\n'
        }
    ...
    switch (n)
    {
        ...
        s += gi + "{\n"
        var list = ((_822_25_=n.whens) != null ? _822_25_ : [])
        for (var _822_14_ = 0; _822_14_ < list.length; _822_14_++)
        {
            e = list[_822_14_]
            s += gi + this.node(e) + '\n'
        }
        if (valid(n.else))
        {
            ...
            for (var _827_18_ = 0; _827_18_ < list1.length; _827_18_++)
            {
                e = list1[_827_18_]
                s += this.indent + '    ' + this.node(e) + '\n'
            }
    ...
    when (n)
    {
        ...
        var list1 = ((_849_24_=n.then) != null ? _849_24_ : [])
        for (var _849_14_ = 0; _849_14_ < list1.length; _849_14_++)
        {
            e = list1[_849_14_]
            gi = this.ind()
            s += gi + '    ' + this.node(e) + '\n'
    ...
    try (n)
    {
        ...
        s += '\n'
        s += gi + '}'
        if (((_872_19_=n.catch) != null ? _872_19_ : []))
        {
            s += '\n'
    ...
    operation (op)
    {
        var opmap, o, sep, ro, _948_40_, _948_29_, open, close, s, keyval, val, i, _971_21_, _971_60_, _971_50_, _971_39_, _975_33_, _975_22_, first, prfx, _980_43_
        ...
        opmap = function (o)
        {
            ...
            omp = {and:'&&',or:'||',not:'!','==':'===','!=':'!=='}
            return ((_941_19_=omp[o]) != null ? _941_19_ : o)
        }
        ...
        if (['<','<=','===','!==','>=','>'].indexOf(o) >= 0)
        {
            ro = opmap(((_948_29_=op.rhs) != null ? (_948_40_=_948_29_.operation) != null ? _948_40_.operator.text : undefined : undefined))
            if (['<','<=','===','!==','>=','>'].indexOf(ro) >= 0)
            {
        ...
        if (o === '=')
        {
            if (op.lhs.object)
            {
                ...
                for (var _958_27_ = 0; _958_27_ < list.length; _958_27_++)
                {
                    keyval = list[_958_27_]
            ...
            if (op.lhs.array)
            {
                ...
                for (var _964_24_ = 0; _964_24_ < list1.length; _964_24_++)
                {
                    val = list1[_964_24_]
        ...
        {
            if ((op.rhs != null ? op.rhs.incond : undefined) || ((_971_39_=op.rhs) != null ? (_971_50_=_971_39_.operation) != null ? (_971_60_=_971_50_.operator) != null ? _971_60_.text : undefined : undefined : undefined) === '=')
            {
                open = '('
                close = ')'
            }
        }
        else if (((_975_22_=op.rhs) != null ? (_975_33_=_975_22_.operation) != null ? _975_33_.operator.text : undefined : undefined) === '=')
        {
            open = '('
            close = ')'
        }
