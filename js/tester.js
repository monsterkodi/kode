...
class Tester
{
    ...
    section (t, f)
    {
        ...
        comps = 0
        depth = stack.length
        console.log(_k_.W1(_k_.lpad(depth * 3 - 1) + ' ' + global[`g${Math.max(1,8 - 2 * depth)}`](_k_.rpad(34 - depth * 3,t) + ' ')))
        f()
        return stack.pop()
    }
