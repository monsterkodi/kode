...
Parse = (function ()
{
    ...
    Parse.prototype["ifSuitableForInline"] = function (e)
    {
        var ei, _783_21_, _784_21_, _785_21_, _786_21_, _791_21_, _792_21_

        if (e.if)
        {
            if ((e.then != null ? e.then.length : undefined) > 1)
            {
                return false
            }
            if ((e.then != null ? e.then[0].if : undefined))
            {
                if (!this.ifSuitableForInline(e.then[0]))
                {
                    return false
                }
            }
            if ((e.else != null ? e.else.length : undefined) > 1)
            {
                return false
            }
            if ((e.else != null ? e.else[0].if : undefined))
            {
                if (!this.ifSuitableForInline(e.else[0]))
                {
                    return false
                }
            }
            var list = _k_.list(e.elifs)
            for (var _787_19_ = 0; _787_19_ < list.length; _787_19_++)
            {
                ei = list[_787_19_]
        ...
        _k_.dbg("kode/parse.kode", 794, 8, null, 'not!')
        return false
    }
