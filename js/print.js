...
class Print
{
    ...
    static ast (header, ast)
    {
        ...
        {
            var name, s, value, _123_44_, _123_85_
            ...
            if (node.type)
            {
                s += _k_.b6(kstr.lpad(((_123_44_=node.line) != null ? _123_44_ : ''),4)) + ' ' + blue(kstr.lpad(((_123_85_=node.col) != null ? _123_85_ : ''),3)) + ' ' + gray(kstr.pad(node.type,10)) + ' ' + bold(yellow(indent + node.text) + '\n')
            }
    ...
    static astr (ast, scopes)
    {
        ...
        if (ast instanceof Array)
        {
            s = (function () { var _190__41_ = []; var list = _k_.list(ast); for (var _190_41_ = 0; _190_41_ < list.length; _190_41_++)  { node = list[_190_41_];_190__41_.push(printNode(node))  } return _190__41_ }).bind(this)().join('')
        }
        else
        {
            s = printNode(ast)
