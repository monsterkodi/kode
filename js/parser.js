...
Parser = (function ()
{
    ...
    Parser.prototype["curly"] = function (open, tokens)
    {
        ...
        if (!close)
        {
            _k_.dbg("kode/parser.kode", 701, 12, "exps", exps)
            _k_.dbg("kode/parser.kode", 702, 12, "tokens", tokens)
        }
        this.pop('{')
    ...
    Parser.prototype["prop"] = function (obj, tokens)
    {
        ...
        if (!prop)
        {
            ...
            print.sheap(this.sheap,'no prop')
        }
        prop.type = 'var'
