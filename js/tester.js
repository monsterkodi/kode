...
class Tester
{
    ...
    section (t, f)
    {
        ...
        comps = 0
        depth = stack.length
        console.log(_k_.W1(kstr.lpad('',depth * 3 - 1) + ' ' + global[`g${Math.max(1,8 - 2 * depth)}`](kstr.pad(t,34 - depth * 3) + ' ')))
        f()
        return stack.pop()
    }
    ...
    test (text, file)
    {
        ...
        ;        (function (o) {
                ...
                var m = (function (k, v)
            {
                ...
                {
                    stack.push(k)
                    console.log(_k_.G1(_k_.y8(' ' + kstr.pad(k,33) + ' ')))
                    v()
                    return stack.pop()
                }
            })(k, o[k])
