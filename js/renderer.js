...
Renderer = (function() {
    ...
    Renderer.prototype.operation = function(op) {
        var close, first, keyval, len, o, open, opmap, prfx, q, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ro, s, sep;
        opmap = function(o) {
            var omp, ref1;
            omp = {
                and: '&&',
        ...
        if (o === '=') {
            ...
            if ((ref4 = op.rhs) != null ? ref4.incond : void 0) {
                open = '(';
                close = ')';
            }
        } else if (((ref5 = op.rhs) != null ? (ref6 = ref5.operation) != null ? ref6.operator.text : void 0 : void 0) === '=') {
            open = '(';
            close = ')';
        }
        first = firstLineCol(op.lhs);
        prfx = first.col === 0 && ((ref7 = op.rhs) != null ? ref7.func : void 0) ? '\n' : '';
