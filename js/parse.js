...
Parse = (function ()
{
    ...
    {
        var nxt, numTokens, last, first, unspaced, spaced, b, _485_38_, _485_30_
    ...
    {
        var m, name, _564_39_, _564_34_, _565_41_, _565_35_

        if ((mthds != null ? mthds.length : undefined))
        {
            var list = (mthds != null ? mthds : [])
            for (var _563_18_ = 0; _563_18_ < list.length; _563_18_++)
            {
                m = list[_563_18_]
                if (name = ((_564_34_=m.keyval) != null ? (_564_39_=_564_34_.key) != null ? _564_39_.text : undefined : undefined))
                {
