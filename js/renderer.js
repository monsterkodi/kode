...
class Renderer
{
    ...
    use (n)
    {
        var item, jsFile, kodeFile, m, mod, name, relFile, s, _360_25_, _379_29_
        ...
        else
        {
            ...
            for (var _374_18_ = 0; _374_18_ < list1.length; _374_18_++)
            {
                m = list1[_374_18_]
                name = slash.base(m.text)
                s += 'import ' + name
                mod = ((_379_29_=m.text) != null ? _379_29_ : m)
                if (this.file)
                {
                    if (mod[0] === '.')
                    {
