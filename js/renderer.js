...
class Renderer
{
    ...
    fixAsserts (s)
    {
        ...
        if (splt.length > 1)
        {
            ...
            s = ''
            for (var _313_21_ = i = 0, _313_25_ = mtch.length; (_313_21_ <= _313_25_ ? i < mtch.length : i > mtch.length); (_313_21_ <= _313_25_ ? ++i : --i))
            {
                if (mtch.length > 1)
                {
            ...
            for (var _337_21_ = i = 0, _337_25_ = mtch.length; (_337_21_ <= _337_25_ ? i < mtch.length : i > mtch.length); (_337_21_ <= _337_25_ ? ++i : --i))
            {
                s += " : undefined"
            }
            s = `(${s})`
    ...
    class (n)
    {
        var b, bind, bn, con, e, mi, mthds, s, superCall, _396_29_, _402_50_
        ...
        {
            var _391_24_ = this.prepareMethods(mthds); con = _391_24_[0]; bind = _391_24_[1]

            if (bind.length)
            {
                var list = _k_.list(con.keyval.val.func.body.exps)
                for (var _395_22_ = 0; _395_22_ < list.length; _395_22_++)
                {
                    e = list[_395_22_]
                ...
                for (var _400_22_ = 0; _400_22_ < list1.length; _400_22_++)
                {
                    b = list1[_400_22_]
                    bn = b.keyval.val.func.name.text
                    con.keyval.val.func.body.exps = ((_402_50_=con.keyval.val.func.body.exps) != null ? _402_50_ : [])
            ...
            this.indent = '    '
            for (var _411_22_ = mi = 0, _411_26_ = mthds.length; (_411_22_ <= _411_26_ ? mi < mthds.length : mi > mthds.length); (_411_22_ <= _411_26_ ? ++mi : --mi))
            {
                if (mi)
                {
                    s += '\n'
    ...
    function (n)
    {
        var b, bind, bn, callsSuper, con, e, mi, mthds, s, _487_50_, _493_46_
        ...
        if (n.extends)
        {
            ...
            for (var _473_18_ = 0; _473_18_ < list.length; _473_18_++)
            {
                e = list[_473_18_]
        ...
        if ((mthds != null ? mthds.length : undefined))
        {
            var _482_24_ = this.prepareMethods(mthds); con = _482_24_[0]; bind = _482_24_[1]

            if (bind.length)
            {
                var list1 = _k_.list(bind)
                for (var _485_22_ = 0; _485_22_ < list1.length; _485_22_++)
                {
                    b = list1[_485_22_]
                    bn = b.keyval.val.func.name.text
                    con.keyval.val.func.body.exps = ((_487_50_=con.keyval.val.func.body.exps) != null ? _487_50_ : [])
                    con.keyval.val.func.body.exps.unshift({type:'code',text:`this[\"${bn}\"] = this[\"${bn}\"].bind(this)`})
                }
            }
            if (n.extends)
            {
                con.keyval.val.func.body.exps = ((_493_46_=con.keyval.val.func.body.exps) != null ? _493_46_ : [])
                var list2 = _k_.list(con.keyval.val.func.body.exps)
                for (var _494_22_ = 0; _494_22_ < list2.length; _494_22_++)
                {
                    e = list2[_494_22_]
            ...
            this.indent = '    '
            for (var _504_22_ = mi = 0, _504_26_ = mthds.length; (_504_22_ <= _504_26_ ? mi < mthds.length : mi > mthds.length); (_504_22_ <= _504_26_ ? ++mi : --mi))
            {
    ...
    funcs (n, className)
    {
        var f, member, s, _524_23_, _524_28_, _539_23_, _539_28_, _539_34_

        s = ''
        if (f = ((_524_23_=n.keyval) != null ? (_524_28_=_524_23_.val) != null ? _524_28_.func : undefined : undefined))
        {
        ...
        {
            if (((_539_23_=n.keyval) != null ? (_539_28_=_539_23_.key) != null ? (_539_34_=_539_28_.text) != null ? _539_34_[0] : undefined : undefined : undefined) === '@')
            {
    ...
    {
        var ast, bind, con, m, name, _568_37_

        bind = []
        var list = _k_.list(mthds)
        for (var _553_14_ = 0; _553_14_ < list.length; _553_14_++)
        {
            m = list[_553_14_]
            if (!m.keyval)
            {
    ...
    func (n, name)
    {
        var args, gi, s, str, t, ths, vs, _591_22_, _591_29_, _596_21_, _596_29_, _606_22_, _606_32_
        ...
        gi = this.ind()
        name = (name != null ? name : ((_591_29_=(n.name != null ? n.name.text : undefined)) != null ? _591_29_ : 'function'))
        s = name
        s += ' ('
        args = ((_596_21_=n.args) != null ? (_596_29_=_596_21_.parens) != null ? _596_29_.exps : undefined : undefined)
        if (args)
        {
            var _598_23_ = this.args(args); str = _598_23_[0]; ths = _598_23_[1]
        ...
        if (((_606_22_=n.body.exps) != null ? _606_22_[0] != null ? (_606_32_=_606_22_[0].call) != null ? _606_32_.callee.text : undefined : undefined : undefined) === 'super')
        {
            s += '\n'
        ...
        if (!_k_.empty(ths))
        {
            ...
            for (var _619_18_ = 0; _619_18_ < list.length; _619_18_++)
            {
                t = list[_619_18_]
                s += this.indent + t + '\n'
            }
    ...
    args (args)
    {
        ...
        for (var _655_14_ = 0; _655_14_ < list.length; _655_14_++)
        {
            a = list[_655_14_]
            if (a.text)
            {
                ...
                if (used[txt])
                {
                    for (i = 1; i <= 100; i++)
                    {
                        if (!used[txt + i])
                        {
                            ...
                            txt += i
                            used[txt] = txt
                            return `${txt}` + (((_670_63_=t.split('=')[1]) != null ? _670_63_ : ''))
                        }
                    }
                }
                else
    ...
    if (n)
    {
        ...
        for (var _795_17_ = 0; _795_17_ < list.length; _795_17_++)
        {
            elif = list[_795_17_]
            s += '\n'
    ...
    ifInline (n, dontClose)
    {
        ...
        {
            s += (function () { var r_826_33_ = []; var list = _k_.list(n.then); for (var _826_33_ = 0; _826_33_ < list.length; _826_33_++)  { e = list[_826_33_];r_826_33_.push(this.atom(e))  } return r_826_33_ }).bind(this)().join(', ')
        }
        if (n.elifs)
        {
            var list1 = _k_.list(n.elifs)
            for (var _829_18_ = 0; _829_18_ < list1.length; _829_18_++)
            {
                e = list1[_829_18_]
                s += ' : '
        ...
        if (n.else)
        {
            ...
            {
                s += '(' + (function () { var r_838_42_ = []; var list2 = _k_.list(n.else); for (var _838_42_ = 0; _838_42_ < list2.length; _838_42_++)  { e = list2[_838_42_];r_838_42_.push(this.atom(e))  } return r_838_42_ }).bind(this)().join(', ') + ')'
            }
        }
        else if (!dontClose)
        {
    ...
    each (n)
    {
        var fnc, i, numArgs, rv, _851_33_, _896_35_
...
${i}})(${this.node(n.lhs)})
    ...
    {
        var e, eb, g2, gi, iterVar, j, list, listVar, nl, postfix, prefix, s, v, _948_27_, _970_28_
        ...
        {
            if (((_948_27_=n.list.array) != null ? _948_27_.items[0] != null ? _948_27_.items[0].slice : undefined : undefined) || n.list.slice)
            {
        ...
        else if ((n.vals.array != null ? n.vals.array.items : undefined))
        {
            s += gi + `for (var ${iterVar} = 0; ${iterVar} < ${listVar}.length; ${iterVar}++)` + nl
            s += gi + "{" + nl
            for (var _973_21_ = j = 0, _973_25_ = n.vals.array.items.length; (_973_21_ <= _973_25_ ? j < n.vals.array.items.length : j > n.vals.array.items.length); (_973_21_ <= _973_25_ ? ++j : --j))
            {
        ...
        for (var _982_14_ = 0; _982_14_ < list1.length; _982_14_++)
        {
            e = list1[_982_14_]
    ...
    {
        var e, eb, end, g2, gi, invCmp, iterCmp, iterDir, iterEnd, iterStart, iterVar, llc, loopCheck, loopStart, loopUpdate, lv, nl, postfix, prefix, rlc, rv, s, slice, start, _1009_32_, _999_28_, _999_46_

        slice = ((_999_46_=((_999_28_=n.list.array) != null ? _999_28_.items[0] != null ? _999_28_.items[0].slice : undefined : undefined)) != null ? _999_46_ : n.list.slice)
        gi = lineBreak || this.ind()
        nl = lineBreak || '\n'
        eb = lineBreak && ';' || '\n'
        g2 = lineBreak ? '' : this.indent
        iterVar = ((_1009_32_=n.vals.text) != null ? _1009_32_ : n.vals[0].text)
        ...
        for (var _1047_14_ = 0; _1047_14_ < list.length; _1047_14_++)
        {
            e = list[_1047_14_]
            prefix = lastPrefix && e === n.then.slice(-1)[0] ? lastPrefix : ''
            postfix = lastPostfix && e === n.then.slice(-1)[0] ? lastPostfix : ''
    ...
    {
        var e, eb, g2, gi, key, nl, obj, postfix, prefix, s, val, _1069_26_

        gi = lineBreak || this.ind()
        nl = lineBreak || '\n'
        eb = lineBreak && ';' || '\n'
        g2 = lineBreak ? '' : this.indent
        key = ((_1069_26_=n.vals.text) != null ? _1069_26_ : (n.vals[0] != null ? n.vals[0].text : undefined))
        ...
        var list = _k_.list(n.then)
        for (var _1078_14_ = 0; _1078_14_ < list.length; _1078_14_++)
        {
            e = list[_1078_14_]
            prefix = lastPrefix && e === n.then.slice(-1)[0] ? lastPrefix : ''
            postfix = lastPostfix && e === n.then.slice(-1)[0] ? lastPostfix : ''
    ...
    switch (n)
    {
        ...
        if (!_k_.empty(n.else))
        {
            ...
            for (var _1147_18_ = 0; _1147_18_ < list1.length; _1147_18_++)
            {
                e = list1[_1147_18_]
    ...
    when (n)
    {
        ...
        for (var _1166_14_ = 0; _1166_14_ < list.length; _1166_14_++)
        {
            e = list[_1166_14_]
        ...
        var list1 = _k_.list(n.then)
        for (var _1169_14_ = 0; _1169_14_ < list1.length; _1169_14_++)
        {
            e = list1[_1169_14_]
            gi = this.ind()
            s += gi + '    ' + this.node(e) + '\n'
    ...
    operation (op)
    {
        var close, first, i, ind, keyval, lhs, o, open, opmap, prfx, ro, s, sep, v, val, _1277_29_, _1277_40_, _1309_25_, _1309_43_, _1309_54_, _1309_64_, _1333_18_, _1333_29_, _1338_25_, _1382_43_
        ...
        opmap = function (o)
        {
            ...
            return ((_1270_19_=omp[o]) != null ? _1270_19_ : o)
        }
        ...
        if (_k_.in(o,['<','<=','===','!==','>=','>','_k_.eql']))
        {
            ro = opmap(((_1277_29_=op.rhs) != null ? (_1277_40_=_1277_29_.operation) != null ? _1277_40_.operator.text : undefined : undefined))
        ...
        if (o === '=')
        {
            if (op.lhs.object)
            {
                ...
                for (var _1288_31_ = 0; _1288_31_ < list.length; _1288_31_++)
                {
                    keyval = list[_1288_31_]
            ...
            if (op.lhs.array)
            {
                ...
                for (var _1297_28_ = 0; _1297_28_ < list1.length; _1297_28_++)
                {
                    val = list1[_1297_28_]
        ...
        {
            if ((op.rhs != null ? op.rhs.incond : undefined) || _k_.in(((_1309_43_=op.rhs) != null ? (_1309_54_=_1309_43_.operation) != null ? (_1309_64_=_1309_54_.operator) != null ? _1309_64_.text : undefined : undefined : undefined),['=','is']))
            {
                open = '('
                close = ')'
            }
        ...
        else if (((_1333_18_=op.rhs) != null ? (_1333_29_=_1333_18_.operation) != null ? _1333_29_.operator.text : undefined : undefined) === '=')
        {
            open = '('
            close = ')'
        }
    ...
    index (p)
    {
        var addOne, from, ni, slice, u, upper, upto, _1451_32_, _1455_32_, _1457_25_, _1457_54_, _1473_27_
    ...
    slice (p)
    {
        ...
        if ((p.from.type === 'num' && 'num' === (p.upto != null ? p.upto.type : undefined)))
        {
            ...
            if (upto - from <= 10)
            {
                ...
                return '[' + ((function () { var r_1508_30_ = []; for (var _1508_34_ = x = from, _1508_40_ = upto; (_1508_34_ <= _1508_40_ ? x <= upto : x >= upto); (_1508_34_ <= _1508_40_ ? ++x : --x))  { r_1508_30_.push(x)  } return r_1508_30_ }).bind(this)().join(',')) + ']'
            }
            else
            {
                o = p.dots.text === '...' ? '<' : '<='
    ...
    stripol (chunks)
    {
        ...
        for (var _1525_18_ = 0; _1525_18_ < list.length; _1525_18_++)
        {
            chunk = list[_1525_18_]
            t = chunk.text
            switch (chunk.type)
            {
                case 'open':
    ...
    sortVars (vars)
    {
        ...
        vl = (function () { var r_1625_27_ = []; var list = _k_.list(vars); for (var _1625_27_ = 0; _1625_27_ < list.length; _1625_27_++)  { v = list[_1625_27_];r_1625_27_.push(v.text)  } return r_1625_27_ }).bind(this)()
    ...
    freshVar (name, suffix = 0)
    {
        ...
        for (var _1640_17_ = 0; _1640_17_ < list.length; _1640_17_++)
        {
            vars = list[_1640_17_]
            var list1 = _k_.list(vars)
            for (var _1641_18_ = 0; _1641_18_ < list1.length; _1641_18_++)
            {
                v = list1[_1641_18_]
