...
Parse = (function ()
{
    ...
    {
        var block, e, numTokens, tok, _271_34_, _333_33_
        ...
        this.sheapPush('exp',((_271_34_=tok.text) != null ? _271_34_ : tok.type))
        e = tok
        while (tokens.length)
        {
            numTokens = tokens.length
        ...
        this.sheapPop('exp',((_333_33_=tok.text) != null ? _333_33_ : tok.type))
        return e
    }

    Parse.prototype["rhs"] = function (e, tokens)
    {
        var llc, numTokens, nxt, spaced, unspaced, _394_22_
