...
Parser = (function(superClass) {
    ...
    Parser.prototype.ifBlock = function(tok, tokens, e) {
        ...
        this.push('if');
        subbs = this.subBlocks(tokens.shift());
        if (!e) {
            tokens = subbs.shift();
            e = {
                "if": {
